...
namespace sparrow_extensions
{
    TEST_SUITE("uuid_array")
    {
        ...
        static std::array<sparrow::byte_t, 16> make_test_uuid(uint8_t pattern)
        {
            std::array<sparrow::byte_t, 16> uuid;
            for (size_t i = 0; i < 16; ++i)
            {
                uuid[i] = static_cast<sparrow::byte_t>(pattern + i);
            }
            return uuid;
        }
        ...
        TEST_CASE("constructor")
        {
            ...
            {
                std::vector<sparrow::nullable<std::array<sparrow::byte_t, 16>>> nullable_uuids = {
        ...
        TEST_CASE("insert")
        {
            SUBCASE("insert single value")
            {
                ...
                ar.insert(ar.cbegin() + 1, sparrow::make_nullable(new_uuid));
            ...
            SUBCASE("insert multiple values")
            {
                ...
                ar.insert(ar.cbegin() + 1, sparrow::make_nullable(new_uuid), 2);
        ...
        TEST_CASE("resize")
        {
            ...
            {
                auto [ar, input_values] = make_array(5, 0);
                ar.resize(3, sparrow::make_nullable(make_test_uuid(0)));
                CHECK_EQ(ar.size(), 3);
            }
            ...
            SUBCASE("resize larger with value")
            {
                ...
                ar.resize(5, sparrow::make_nullable(fill_uuid));
        ...
        TEST_CASE("real-world UUID patterns")
        {
            SUBCASE("RFC 4122 UUID example")
            {
                ...
                std::array<sparrow::byte_t, 16> uuid1 = {
                    sparrow::byte_t{0x55},
                    sparrow::byte_t{0x0e},
                    sparrow::byte_t{0x84},
                    sparrow::byte_t{0x00},
                ...
                std::array<sparrow::byte_t, 16> uuid2 = {
                    sparrow::byte_t{0x6b},
                    sparrow::byte_t{0xa7},
                    sparrow::byte_t{0xb8},
                    sparrow::byte_t{0x10},
                ...
                std::vector<std::array<sparrow::byte_t, 16>> uuids = {uuid1, uuid2};
                const uuid_array ar(uuids);
            ...
            {
                std::array<sparrow::byte_t, 16> nil_uuid = {};  // All zeros
                std::vector<std::array<sparrow::byte_t, 16>> uuids = {nil_uuid};
                const uuid_array ar(uuids);
